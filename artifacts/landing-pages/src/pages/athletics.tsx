              ...
              {[
                ...
                >
                  <div className="overflow-hidden bg-neutral-50 flex items-center justify-center max-h-[250px] md:max-h-[400px]">
                    <img src={item.image} alt={`${item.name} — BH Labs Recovery Pod for university athletics`} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500 max-h-[250px] md:max-h-[400px]" loading="lazy" />
                  </div>
                  <div className="p-5">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-12">
              <ContactForm
                ...
                title="Download the Athletics Recovery Brief"
                subtitle="Get the 2-page overview of how BH Labs Recovery Pods serve university athletics programs."
              />
              ...
              {!showProposalForm ? (
                ...
                >
                  <p className="text-muted-foreground mb-4">Ready to explore a full proposal for your program?</p>
                  <Button
                    size="lg"
                    variant="outline"
                    className="h-14 px-8 text-base"
                    onClick={() => setShowProposalForm(true)}
                    data-testid="btn-show-proposal"
                  >
                    Request a Proposal
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
