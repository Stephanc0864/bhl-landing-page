...
export default function ThankYou() {
  useEffect(() => {
    document.title = "Thank You | Fitness & Padel Club Recovery Pod | BH Labs";
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                You're one step closer to turning unused club space into a premium recovery revenue stream for your members.
              </motion.p>
            ...
            >
              <motion.div variants={FADE_UP} className="text-center mb-8">
                ...
                <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
                  In 30 minutes, we'll review your facility layout, estimate recovery revenue potential, and outline a clear path to launch. No commitment required.
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-3">
                Why Fitness & Padel Clubs Add Recovery Pods
              </h2>
              <p className="text-muted-foreground text-base max-w-xl mx-auto">
                Facilities that install a BH Labs Recovery Pod unlock measurable advantages for their business and members.
              </p>
            </motion.div>
            ...
            >
              {[
                {
                  icon: DollarSign,
                  title: "New Revenue from Underused Space",
                  desc: "Convert underperforming square footage into a self-sustaining recovery revenue center generating recurring monthly income.",
                },
                {
                  icon: Sparkles,
                  title: "Premium Member Recovery Experience",
                  desc: "Offer a recovery and wellness amenity that most competing gyms and clubs simply don't have yet.",
                },
                {
                  icon: Users,
                  title: "Increased Retention & Differentiation",
                  desc: "Members who recover better train more consistently, stay longer, and refer more — reducing churn and elevating your brand.",
                },
                {
                  icon: Settings,
            ...
            >
              ...
              <motion.div variants={STAGGER} className="space-y-4">
                {[
                  {
                    icon: LayoutGrid,
                    title: "Review Your Gym / Club / Padel Facility Layout",
                    desc: "We'll assess your available space and discuss optimal pod placement for maximum member visibility and flow.",
                  },
                  {
                    icon: TrendingUp,
                    title: "Estimate Revenue Opportunity",
                    desc: "Using your facility data, we'll model projected monthly recovery revenue and payback timelines.",
                  },
                  {
                    icon: Zap,
                    title: "Discuss Equipment Configuration",
                    desc: "We'll recommend the right combination of modalities based on your member profile and facility type.",
                  },
                  {
                    icon: Clock,
                    title: "Outline Timeline & Next Steps",
                    desc: "From design approval to ribbon-cutting — we'll map out the implementation roadmap for your facility.",
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
